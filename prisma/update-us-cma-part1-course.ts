...
async function main() {
  ...
  const assessments = [
    { title: 'External Financial Reporting Assessment', type: 'SCENARIO' as const },
    { title: 'Planning, Budgeting & Forecasting Test', type: 'SCENARIO' as const },
    { title: 'Performance Management Assessment', type: 'SCENARIO' as const },
    { title: 'Cost Management Test', type: 'SCENARIO' as const },
    { title: 'Internal Controls Assessment', type: 'SCENARIO' as const },
    { title: 'Technology & Analytics Test', type: 'SCENARIO' as const },
  ];

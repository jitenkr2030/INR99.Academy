...
async function main() {
  console.log('🌱 Adding comprehensive sample data to match landing page claims...')
  ...
  // Additional courses to reach 50+ total
  ...
  // Create additional subcategories for the new categories
  ...
  await prisma.subCategory.createMany({
    data: additionalSubCategories,
  })

  console.log('✅ Added additional subcategories for Data Science and Digital Marketing')

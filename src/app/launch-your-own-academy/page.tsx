        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{
            ...
            <p style={{ color: '#166534', fontSize: '0.9375rem', margin: 0 }}>
              <strong>Volume Discounts:</strong> Larger institutions benefit from lower per-student rates. Contact our sales team for institutions above 2000 students.
            </p>
          </div>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: '#6b7280', fontSize: '0.9375rem' }}>
                Volume-based pricing from ₹99/month per student - best value in the market
              </p>
            </div>
